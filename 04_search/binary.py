...
def binary_search_with_recursion(numbers: List[int], value: int) -> IndexNum:
    def _binary_search(
        numbers: List[int], value: int, left: IndexNum, right: IndexNum
    ) -> IndexNum:
        print("binary_search_with_recursion")
...
if __name__ == "__main__":
    ...
    print(binary_search_with_recursion(nums, 15))
